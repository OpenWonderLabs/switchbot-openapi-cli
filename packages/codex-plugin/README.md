...
- An MCP server definition that runs `switchbot mcp serve` (default profile, 17 tools; pass `--tools all` to add the policy/audit/rules tools for 25 total)
...
`switchbot codex setup` installs or upgrades the CLI and Codex plugin packages
