...
export const DEVICE_CATALOG: DeviceCatalogEntry[] = [
  ...
  },
  {
    ...
    statusFields: ['power', 'onlineStatus', 'brightness', 'color', 'colorTemperature', 'version'],
  },
  {
    type: 'Ceiling Light',
    category: 'physical',
  ...
  },
  {
    ...
    statusFields: ['power', 'onlineStatus', 'mainLightPower', 'mainLightBrightness', 'mainLightColorTemp', 'colorLightPower', 'colorLightBrightness', 'colorLightRGB', 'version'],
  },
  {
  ...
  },
  {
    ...
    commands: [
      { command: 'customQuote', parameter: 'custom text', description: 'Set a custom quote on the display', idempotent: true, exampleParams: ['Hello from SwitchBot'] },
      { command: 'cancelCustom', parameter: 'default', description: 'Revert to default quote display', idempotent: true },
      { command: 'customPage', parameter: 'custom text', description: 'Set a custom page text', idempotent: true, exampleParams: ['Today is a great day'] },
    ],
    statusFields: ['temperature', 'humidity', 'battery', 'version'],
  },
  ...
  },
  {
    ...
    role: 'other',
    commands: [
      { command: 'mode', parameter: '"Normal", "Standby", or "Sleep"', description: 'Set the operating mode', idempotent: true, exampleParams: ['Normal'] },
      { command: 'childLock', parameter: '"on" or "off"', description: 'Toggle child lock', idempotent: true, exampleParams: ['off'] },
      { command: 'backHome', parameter: 'default', description: 'Command Kata to return home', idempotent: true },
      { command: 'pictureTaking', parameter: '"on" or "off"', description: 'Toggle picture taking', idempotent: true, exampleParams: ['on'] },
      { command: 'snapshots', parameter: '"on" or "off"', description: 'Toggle snapshot mode', idempotent: true, exampleParams: ['on'] },
      { command: 'talk', parameter: '"on" or "off"', description: 'Toggle talk mode', idempotent: true, exampleParams: ['on'] },
    ],
