...
- 🧪 **Fully tested** — 1898 Vitest tests, mocked axios, zero network in CI
...
npm test                    # Run the Vitest suite (1898 tests)
...
tests/                    # Vitest suite (1898 tests, mocked axios, no network)
```
