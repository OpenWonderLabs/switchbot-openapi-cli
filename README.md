...
- 🧪 **Fully tested** — 1895 Vitest tests, mocked axios, zero network in CI
...
npm test                    # Run the Vitest suite (1895 tests)
...
tests/                    # Vitest suite (1895 tests, mocked axios, no network)
```
