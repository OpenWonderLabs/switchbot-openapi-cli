...
- 🧪 **Fully tested** — 1889 Vitest tests, mocked axios, zero network in CI
...
npm test                    # Run the Vitest suite (1889 tests)
...
tests/                    # Vitest suite (1889 tests, mocked axios, no network)
```
